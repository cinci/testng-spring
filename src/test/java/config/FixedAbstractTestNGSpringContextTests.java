...
public abstract class FixedAbstractTestNGSpringContextTests implements IHookable, ApplicationContextAware {
     ...
     */
    public FixedAbstractTestNGSpringContextTests() {
    ...
    protected void springTestContextBeforeTestSuite() throws Exception {
    ...
    protected void springTestContextAfterTestSuite() throws Exception {
        this.testContextManager.afterTestClass();
    }
}
